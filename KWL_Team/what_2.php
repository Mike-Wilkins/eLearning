...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="kwltabs">
        <ul>
            ...
            <li><a href="what_2.php" id="onlink">What</a></li>
            <li><a href="learned_1.php">Learned</a></li>
...
<!------------------------------------ Student Guidance ----------------------------------------------------------------------------------->
   ...
   <div class="comment-display">
        ...
        <div class="blackboard">
                ...
                <p class="student_guidance">
                    Remember, you can continue to add questions or additional facts at any point. 
                </p>
                <p class="student_guidance">
