...
<!------------------------------------- KWL Display ------------------------------------------------------------->
    <div class="kwl-display">
        <div>
            <input class="nav-button" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_Plus/what_plus_solo.php'" />
        </div>
    
    <div class="kwltabs">
        <ul>
            <li><a href="know_plus.php">Know</a></li>
            <li><a href="what_plus.php" id="onlink">What</a></li>
