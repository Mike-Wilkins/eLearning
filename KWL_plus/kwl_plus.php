...
<header id="home_header">
    ...
    <div class="KWL-plus">
        <img src="../images/kwlplus_logo.png" width="260" height="100" style="position: absolute; left: 80px; top: 10px;">
    </div>
...
<?php
     ...
     if($counter >= 3) {
         $filename = "know_plus.php";
     } else {
         $filename = "know_plus_1.php";
     }
?>
        ...
        <section>
            ...
            <div class="KWL_plus_display_text">
                    ...
                    <ul class="introduction_ul">
                            <li>Click the "Get Started" button which will take you to the first stage of your KWL journey. Here you can collaborate with your team mates and
                                the team you have been paired with to submit any facts you know about planet Earth. You can also share your ideas with the rest of the
