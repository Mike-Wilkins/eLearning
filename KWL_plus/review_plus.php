<?php
    ...
    $dbtable = "kwl_plus_review";
    $page = "../KWL_Plus/review_plus.php";
?>
   ...
   <section>
    <div class="classroom-display">
       ...
       <p class="introduction">
          Congratulations on completing your first journey exploring planet Earth. Before you go we would like you to take 
