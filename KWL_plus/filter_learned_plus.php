...
<section>
    ...
    <div class="kwl-display">
         <div>
            <input class="nav-button" type="button" value="Return to Classroom" onclick="window.location.href='review_plus.php'" />
        </div>
        <div>
            <input class="nav-button" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_Plus/learned_plus_solo.php'" />
        </div>
...
<div class="display_student_work" style="width: 420px; word-wrap: break-word;">
            ...
            <?php
                ...
                $query = $con->prepare('SELECT * FROM learned_comment_plus WHERE comment LIKE ?');
