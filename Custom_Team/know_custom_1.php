<?php
    ...
    $page = "../Custom_Team/know_custom_1.php";
?>
...
<?php
     ...
     if($counter >= 3) {
        header("location: know_custom_2.php?custom_team=$custom_team");
     }?>
...
<!-- KWL Display ------------------------------------------------------------------------------------------------->
    ...
    <div class="kwltabs">
        <ul>
            <li><a href="know_custom_1.php?custom_team=<?php echo($custom_team)?>" id="onlink">Know</a></li>
...
<!------------------------------------ Student Guidance ----------------------------------------------------------------------------------->
   ...
   <div class="comment-display">
        ...
        <div class="blackboard">
            ...
            <p class="student_guidance">
                To move on to the next stage you will need to <span style="color: #ff8566"> enter at least three facts.</span>
            </p>
