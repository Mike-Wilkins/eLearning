...
<section>
    ...
    <div class="kwl-display">
        <div>
            <a href="learned_custom_video.php?custom_team=<?php echo($custom_team)?>">
         ...
         <div>
            <input class="return_to_class_button" type="button" value="Return to Classroom" onclick="window.location.href='review_custom.php?custom_team=<?php echo ($custom_team)?>'" />
        </div>
...
<section>  
        ...
        <form id="filter_form" action="filter_custom_learned.php?custom_team=<?php echo ($custom_team)?>" method="post">
    ...
    <div class="comment-display">
      ...
      <div class="blackboard">
                ...
                <p class="student_guidance">
                    ...
                    investigations. You now have complete access to all three of the KWL tabs.
                </p>
                <p class="student_guidance">
