...
if($error_message =="guest_error"){
    ...
    ?>
     <img class="guest_error fade" src="../images/guest_error.png">
    <?php
}
...
<!-- Create a team --------------------------------------------------------------------------------------------------------------->
   ...
   <div class="classroom-display">
        ...
        <form id="login_form" action="../POST/insert_custom_team2.php" method="post">
            ...
            ?>
                <section>
                    ...
                    <input class="login_details" name="guest1" value="<?php echo($username)?>" readonly="true"><br>
                            ...
                            <input class="add-minus-button" type="button" value="Add" onclick="window.location.href='create_team_2guests.php'" />    
                        </div>
                </section>
                <section>
