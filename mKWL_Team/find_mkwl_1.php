<?php
    ...
    $page = "../mKWL_Team/find_mkwl_1.php";
    $page2 = "find_mkwl_2.php";
?>
...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="mkwltabs">
        <ul>
            ...
            <li><a href="find_mkwl_1.php" id ="onlink">How can I find out</a></li>
...
<!-- Titles --------------------------------------------------------------------------------------->
    <section>
        ...
        <div class="display_questions" style="height: 60px; margin-bottom: 8px; overflow: hidden">
            <p class="title_text">How can I <strong>F</strong>ind out</p>
        </div>
    </section>
...
<!------------------------------------ Student Guidance ----------------------------------------------------------------------------------->
   ...
   <div class="comment-display">
        ...
        <div class="blackboard">
                ...
                <p class="student_guidance">
                    To move on to the next stage you will need to <span style="color: #ff8566"> enter at least three ideas.</span>
                </p>
        
                <p class="student_guidance">
                    When you have entered three or more ideas, click the "Learned" tab to move on to the final stage.
                </p>     
        </div>
    </div>
</section>
