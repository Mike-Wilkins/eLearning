<?php
    ...
    $page = "../mKWL_Team/know_mkwl_1.php";
    $page2 = "know_mkwl_2.php";
...
<!-- Display who is logged in ----------------------------------------------------------------------------------->
    ...
    <div class="mkwltabs">
        <ul>
            <li><a href="know_mkwl_1.php" id="onlink">What I think and know</a></li>
            <li><a style="color: grey">What Questions I have</a></li>
 ...
 <div class="kwl-container">
    ...
    <section>
        <form id="comment_form" action="../POST/insert_comment.php?dbtable=<?php echo $dbtable?>&page=<?php echo $page?>" method="post">
            ...
            <textarea class="know_comments" name="Know_Comment" rows="2" cols="70" maxlength="100" placeholder="Enter what you know or think here"></textarea>
        </form>
    </section>
...
<!------------------------------------ Student Guidance ----------------------------------------------------------------------------------->
   ...
   <div class="comment-display">
        ...
        <div class="blackboard">
            ...
            <p class="student_guidance">
                To move on to the next stage you will need to <span style="color: #ff8566"> submit at least three facts or thoughts.</span>
            </p>
                
            <p class="student_guidance">
                When you have entered three or more ideas, click the "What" tab to move on to the next stage.
            </p>
