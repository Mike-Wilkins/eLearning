<?php
    ...
    $page = "../mKWL_Team/learned_mkwl_2.php";
...
<body>
    ...
    <div>
            <input class="return_to_class_button" style="margin-right: 20px; margin-top: 12px;" type="button" value="Return to Classroom" onclick="window.location.href='review.php'" />
    </div>
...
<section>
    ...
    <div>
         <a href="learned_mkwl_2_video.php">
...
<section>
    ...
    <div class="list_title" style="width: 415px;">
        <p class="title_text">What we have <strong>L</strong>earned</p>
    </div>
</section>
