...
<!-- Display who is logged in ----------------------------------------------------------------------------------->
    ...
    <div class="kwl-display">
        <div>
            <input class="solo_button" style="margin-right: 15px" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_mkwl/know_solo.php'" />
        </div>
       
       
    <div class="mkwltabs">
        <ul>
            <li><a href="know_mkwl.php" id ="onlink">What I think and know</a></li>
...
<div class="chat">
        ...
        <form id="comment_form" action="../POST/insert_discussion.php?dbtable=<?php echo $discussion_table?>&page=<?php echo $page?>" method="post">
            <div class="titleformat">
                <p>Share your ideas about forces and gravity with other students</p>
            </div>
