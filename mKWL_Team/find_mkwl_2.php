...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="mkwltabs">
        <ul>
            ...
            <li><a href="find_mkwl_2.php" id ="onlink">How can I find out</a></li>
            <li><a href="learned_mkwl_1.php" >What I learned</a></li>
...
<!------------------------------------ Student Guidance ----------------------------------------------------------------------------------->
   ...
   <div class="comment-display">
        ...
        <p class="student_guidance">
                Excellent!!.....you are now ready to move on to the final stage.
            </p>
                
            <p class="student_guidance">
                Remember, you can keep adding additional facts and ideas at any point.
            </p>
            <p class="student_guidance">
                When you are ready, click the "Learned" tab to move on to the next stage.
            </p>
