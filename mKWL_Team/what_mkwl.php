<?php
    ...
    $page = "../mKWL_Team/what_mkwl.php";
    $discussion_table = "what_discussion_mkwl";
?>
...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="kwl-display">
        <div>
            <input class="solo_button" style="margin-right: 15px" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_mkwl/what_solo.php'" />
        </div>
       
    <div class="mkwltabs">
        <ul>
            <li><a href="know_mkwl.php">What I think and know</a></li>
            <li><a href="what_mkwl.php" id ="onlink">What Questions I have</a></li>
...
<!-- Titles --------------------------------------------------------------------------------------->
    <section>
        <div class="display_facts" style="height: 60px; margin-bottom: 8px; overflow: hidden">
            <p class="title_text">What we <strong>T</strong>hink and what we <strong>K</strong>now</p>
        </div>
...
<div class="chat">
        ...
        <form id="comment_form" action="../POST/insert_discussion.php?dbtable=<?php echo $discussion_table?>&page=<?php echo $page?>" method="post">
            <div class="titleformat">
                <p>What would you like to know about forces and gravity?...share your questions with other students</p>
            </div>
