...
<body>
    ...
    <div class="KWL-images">
        <img src="images/KWL_team_logo.png" width="220" height="80">
    </div>
...
<?php
     ...
     $getsql = "SELECT * FROM learned_comment ORDER BY id ASC";
...
<!-- Today's Lesson and Introduction page --------------------------------------------------------------------------------------------------------->

</div>
   <section>
    <div class="classroom-display">
        <div>
          <input class="nav-button" type="button" value="Get Started" onclick="window.location.href='KWL_Team/<?php echo($filename)?>'" />
        </div>
    <p class="subject-title">Today's Lesson</p>
       ...
       <ul class="introduction_ul">
            ...
            <li>Click the "Get Started" button which will take you to the first stage of your KWL journey. Here you can submit any facts you know
                about the solar system and the planets. You can also share your ideas with the rest of the class using the discussion
                forum at the bottom of the page.</li>
