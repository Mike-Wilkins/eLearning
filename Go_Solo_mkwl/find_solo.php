<?php
    ...
    $page = "../Go_Solo_mkwl/find_solo.php";
...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="kwl-display">
        <div>
            <input class="solo_button" style="margin-right: 15px" type="button" value="Team" onclick="window.location.href='../mKWL_Team/find_mkwl.php'" />
        </div>
    ...
    <div class="mkwltabs">
        <ul>
            ...
            <li><a href="find_solo.php" id ="onlink">How can I find out</a></li>
