<?php
    ...
    $page = "../Go_Solo_mkwl/what_solo.php";
...
<!-- KWL Display -------------------------------------------------------------------------------------------------->
    ...
    <div class="kwl-display">
        <div>
            <input class="solo_button" style="margin-right: 15px" type="button" value="Team" onclick="window.location.href='../mKWL_Team/what_mkwl.php'" />
        </div>
       
    <div class="mkwltabs">
        <ul>
            <li><a href="know_solo.php" >What I think and know</a></li>
            <li><a href="what_solo.php" id ="onlink">What Questions I have</a></li>
