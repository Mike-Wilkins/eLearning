...
<body>
    ...
    <div>
            <input disabled class="return_to_class_button" style="margin-right: 20px; margin-top: 12px;" type="button" value="Return to Classroom" onclick="window.location.href='../mKWL_Team/review.php'" />
    </div>
...
<div class="kwl-container">
     ...
     <section>  
        <form id="comment_form" action="insert_learned_solo.php" method="post">
...
<!-- Display class resources ---------------------------------------------------------------------------------------------------->
    ...
    <div class="websites">
            ...
            <div class="links" style="word-wrap: break-word;">
                ...
                $getsql ="SELECT DISTINCT website FROM learned_comment_mkwl ORDER BY id DESC";
                $data = $con -> query($getsql);
                ?>
