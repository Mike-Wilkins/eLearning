...
$b_success = false;
    ...
    if(isset($_POST['custom_team']) && isset($_POST['guest1']) && isset($_POST['guest2']) && isset($_POST['submit'])){
       ...
       if($message != "team_error"){
            if($custom_team && $guest1 != $guest2) {
                $sql = "INSERT INTO custom_team (myteam, user1, user2) VALUES (:myteam, :user1, :user2)";
    ...
    $con = null;
    header("location: ../Custom_Team/create_team.php?$message");
