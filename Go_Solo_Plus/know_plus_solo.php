<?php
    ...
    $page = "../Go_Solo_Plus/know_plus_solo.php";
...
<!------------------------------------- KWL Display ------------------------------------------------------------->
    <div class="kwl-display">
        <div>
            <input class="nav-button" type="button" value="Team" onclick="window.location.href='../KWL_plus/know_plus.php'" />
        </div>
    
    <div class="kwltabs">
        <ul>
            <li><a href="know_plus_solo.php" id="onlink">Know</a></li>
