<?php
    ...
    $page = "../Go_Solo_Plus/what_plus_solo.php";
    $discussion_table = "what_discussion_plus";
?>
...
<!------------------------------------- KWL Display ------------------------------------------------------------->
    <div class="kwl-display">
        <div>
            <input class="nav-button" type="button" value="Team" onclick="window.location.href='../KWL_plus/what_plus.php'" />
        </div>
    
    <div class="kwltabs">
        <ul>
            <li><a href="know_plus_solo.php">Know</a></li>
            <li><a href="what_plus_solo.php" id="onlink">What</a></li>
            <li><a href="learned_plus_solo.php">Learned</a></li>
        </ul>
    </div>
...
<section>
<div class="list_title" style="padding-left: 160px;">
...
<!-- Student Guidance -------------------------------------------------------------------------------------->
    ...
    <div style="margin-left: 60px;">
      ...
      <div class="blackboard">
                ...
                <p class="student_guidance">
                    Remember, you can also read what ideas other students in both teams have and add your own ideas to the student forum below. 
        ...
        <div class="chat">
            <form id="comment_form" action="../POST/insert_discussion.php?dbtable=<?php echo $discussion_table?>&page=<?php echo $page?>" method="post">
                    <div class="titleformat">
                        <p>Share questions about planet Earth with other students</p>
                    </div>
