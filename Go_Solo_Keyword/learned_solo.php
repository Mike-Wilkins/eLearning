<?php
    ...
    $page = "../Go_Solo_Keyword/learned_solo.php?";
...
<section>
    ...
    <div class="kwl-display">
        ...
        <div>
         ...
         <div>
            <input class="return_to_class_button" type="button" value="Return to Classroom" onclick="window.location.href='../KWL_Keyword/review.php'" />
        </div>
        <div>
            <input class="solo_button" type="button" value="Team" onclick="window.location.href='../KWL_Keyword/learned.php'" />
        </div>
