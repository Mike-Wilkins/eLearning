...
<section>
    ...
    <div class="kwl-display">
        ...
        <div>
            <input class="nav-button" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_Keyword/learned_solo.php'" />
        </div>
...
<div class="display_student_work" style="width: 420px; word-wrap: break-word;">
            ...
            <?php
                ...
                $query = $con->prepare('SELECT * FROM learned_comment_keyword WHERE comment LIKE ?');
    ...
    <div class="comment-display">
      ...
      <div class="blackboard">
                ...
                <p class="student_guidance">
                    ...
                    Enter what you have learned about our planet Earth in the comment box provided 
