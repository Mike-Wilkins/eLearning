...
<section>
    ...
    <div class="kwl-display">
        ...
        <div>
            <input class="solo_button" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_Keyword/learned_solo.php'" />
        </div>
...
<div class="kwl-container">
        ...
        ?>
<section>  
        <form id="comment_form" action="POST/insert_learned.php" method="post">
