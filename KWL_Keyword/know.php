...
<!-- Display KWL ----------------------------------------------------------------------------------------------------------->
    ...
    <div class="kwl-display">
        <div>
            <input class="nav-button" type="button" value="Go Solo" onclick="window.location.href='../Go_Solo_Keyword/know_solo.php'" />
        </div>
       
    <div class="kwltabs">
        <ul>
            <li><a href="know.php" id="onlink">Know</a></li>
